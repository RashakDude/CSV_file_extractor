...
parser =  argparse.ArgumentParser('This tool is to split arbitary CSV files based on the header to different files with .txt extensions')
parser.add_argument('-f','--fileToProcess',type=str,help='Specifies the file to be used')
